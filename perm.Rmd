...
Consider the model:
- $Z$ represents Subject ID ($i=1,\ldots,n$)
- $X$ indicates pre/post-treatment status (typically coded as 0 for pre-treatment, 1 for post-treatment)
- Each subject in $Z$ has one pre-treatment and one post-treatment observation
