...
Over B=\ensuremath{10^{4}} permutations we got 9844 times a
...
\(| H_0)\) is equal to \(p =\) 0.0158, i.e.~very small.\\
...
(link.springer.com/content/pdf/10.1007/s11749-017-0571-1.pdf)
...
\mathbb{E}\left[(\#\Pi)^{-1} \cdot \#\{\pi \in \Pi : T(\pi Y) > T^{(k)}(Y)\}\right] \leq \alpha,
\] as was to be shown.
